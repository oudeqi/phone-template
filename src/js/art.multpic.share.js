...
// http://192.168.10.96:3000/art.multpic.share.html?id=2819
...
app.controller("detail",["$scope","$http","APP_HOST","$rootScope",
    function($scope,$http,APP_HOST,$rootScope){
        ...
        var dataForWeixin = {
			...
			imgUrl: "",
			lineLink: "http://fx.2tai.net/art.multpic.share.html?id=" + $rootScope.id,
			descContent: "",
			shareTitle: "",
        ...
        $scope.callApp = function(){
            ...
            .success(function(res){
                ...
                location.href = "./webreg-2.html?comeinCode="+res.data;
            }).error(function(res){
